...
export default class ViewDec1 extends React.Component<IProps, IState> {
    ...
    render() {
        return (
            <div>
                <Button disabled={this.android_pos !== 0} onClick={()=>{this.handleButtonClick({group: "Android", pos: 1})}}>Androids Coming</Button>
                <Button disabled={this.cyborg_pos !== 0} onClick={()=>{this.handleButtonClick({group: "Cyborg", pos: 1})}}>Cyborgs Coming</Button>
