...
export default class ViewDec2 extends React.Component<IProps, IState> {
    ...
    render() {
        return (
            <div>
                <Button disabled={HTUServer.get().android_pos !== 2} onClick={()=>{this.handleButtonClick({group: "Android", pos: 3})}}>Androids Coming</Button>
                <Button disabled={HTUServer.get().cyborg_pos !== 2} onClick={()=>{this.handleButtonClick({group: "Cyborg", pos: 3})}}>Cyborgs Coming</Button>
