...
export default class ViewDec2 extends React.Component<IProps, IState> {
    ...
    render() {
        return (
            <div>
                <Button onClick={()=>{this.handleButtonClick({group: "Android", pos: 3})}}>Androids Coming</Button>
                <Button onClick={()=>{this.handleButtonClick({group: "Cyborg", pos: 3})}}>Cyborgs Coming</Button>
